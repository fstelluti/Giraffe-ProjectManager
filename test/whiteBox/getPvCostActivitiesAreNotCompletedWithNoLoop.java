...
public class getPvCostActivitiesAreNotCompletedWithNoLoop {
	//Create a EVA testing object in order to test the private methods in the EarnedValueAnalyssTab
			...
			@Test
			public void shouldYield625() throws ParseException
			{
				...
				assertEquals(625, evaTestingClass.getPVCostMethod(list, false, new SimpleDateFormat("dd/MM/yyyy").parse("06/01/2000")), 0);
			}
}
