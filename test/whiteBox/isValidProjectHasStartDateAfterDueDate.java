...
public class isValidProjectHasStartDateAfterDueDate {
	...
	public void shouldBeInvalidProject() throws ParseException, InvalidProjectException
	{
		...
		Project testProject1 = new Project(12341234, "test", new Date(), new Date(), "test");
		
		//Set Start date after due date
		testProject1.setDueDate(new SimpleDateFormat("dd/MM/yyyy").parse("01/01/2001"));
		testProject1.setStartDate(new SimpleDateFormat("dd/MM/yyyy").parse("02/01/2001"));
		
		testProject1.addProjectPM(testUser);;
